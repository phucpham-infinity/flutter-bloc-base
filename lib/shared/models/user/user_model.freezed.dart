...
abstract class _User implements User {
  const factory _User({final int id}) = _$_User;
...
class _$_UserList implements _UserList {
  const _$_UserList({final List<User> userList = const []})
      : _userList = userList;
...
abstract class _UserList implements UserList {
  const factory _UserList({final List<User> userList}) = _$_UserList;
