...
import 'package:pine_app/feature/widget/textfield/custom_cursor_painter.dart';
...
class CustomPinCodeTextField extends StatefulWidget {
  ...
  /// The vertical padding from the [CustomPinCodeTextField] to the error text
  /// Default is 16.
...
class _CustomPinCodeTextFieldState extends State<CustomPinCodeTextField>
  ...
  Widget _renderPinField({
    ...
    bool showObscured = !widget.blinkWhenObscuring ||
        ...
        index != _inputList.where((x) => x.isEmpty).length - 1;
